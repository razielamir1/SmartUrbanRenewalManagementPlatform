...
export default async function DeveloperSupervisorDashboard() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold">לוח בקרה — מפקח מטעם היזם</h1>
        <p className="text-muted-foreground mt-1">ניהול מסמכים ועדכון אבני דרך</p>
      </div>
        ...
        {(projects ?? []).map(project => (
          <div key={project.id} className="bg-card rounded-2xl border border-border p-5 space-y-4">
            ...
            <div className="flex gap-3 flex-wrap">
              <Link
                href={`/portal/developer-supervisor/projects/${project.id}/milestones`}
